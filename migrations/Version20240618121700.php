 ...
 */
final class Version20240618121700 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, author_id INT DEFAULT NULL, label TINYTEXT NOT NULL, description LONGTEXT DEFAULT NULL, id_reference INT DEFAULT NULL, video_path_name VARCHAR(255) DEFAULT NULL, added_at DATETIME DEFAULT NULL, views INT DEFAULT NULL, cover LONGTEXT DEFAULT NULL, url LONGTEXT DEFAULT NULL, INDEX IDX_169E6FB912469DE2 (category_id), INDEX IDX_169E6FB9F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE favory (id INT AUTO_INCREMENT NOT NULL, course_id INT NOT NULL, user_identifier VARCHAR(255) NOT NULL, INDEX IDX_F232B2A8591CC992 (course_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE favory ADD CONSTRAINT FK_F232B2A8591CC992 FOREIGN KEY (course_id) REFERENCES course (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE favory DROP FOREIGN KEY FK_F232B2A8591CC992');
