...
final class Version20240523164200 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, author_id INT NOT NULL, label VARCHAR(200) NOT NULL, description LONGTEXT DEFAULT NULL, id_reference INT DEFAULT NULL, type VARCHAR(50) NOT NULL, INDEX IDX_169E6FB912469DE2 (category_id), INDEX IDX_169E6FB9F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE visit (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, course_id INT DEFAULT NULL, nbr_visit INT NOT NULL, last_time_visit DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_437EE939A76ED395 (user_id), INDEX IDX_437EE939591CC992 (course_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
